...
class Request
{
  ...
  {
    return $this->__call('withUserAgent', array($userAgent));
  }
   ...
   * @return string
   */
  private function _serializePayload($payload): string
  {
   ...
   * @return Response
   */
  public static function getQuick($uri, $mime = null): Response
  {
