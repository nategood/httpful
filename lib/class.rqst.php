...
class Response {
	 ...
	 * @param Rqst $request
	 */
	public function __construct($body, $headers, Rqst $request) {
...
class Rqst {
	 ...
	 * class from a template Rqst object.  Simply construct a 
	 * Rqst object as much as you want to and then pass it to
	 ...
	 * @param Rqst $template
	 */
	public static function ini(Rqst $template) {
	...
	*/
	...
	public function send() {
		...
		return new Response($result, array(), $this);
	}
	...
	*/
	 ...
	 * $rqst->withMyHeaderName($my_value);  See the 
	 * `__call` method.
	 * @return Rqst this
	 ...
	 * Rqst instantiation), it promotes readability
	...
	private static function _initializeDefaults() {
		...
		self::$_template = new Rqst(array('method' => Http::GET));
	 ...
	 * should also really only be used internally.  The Rqst::get, 
	 * Rqst::post syntax is preferred as it is more readable.
	 * @return Rqst
